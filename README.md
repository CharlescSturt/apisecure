...
1. **Paste your API key** → Browser encrypts it locally
2. **Set a passphrase** → AES-256-GCM protection
3. **Share the URL** → Recipient decrypts in their browser
4. **Key self-destructs** → Optional expiration
